-- clinica.sql (Corrigido: Adiciona paciente, cpf, dentista à tabela consultas)
...
-- CORREÇÃO APLICADA: ADICIONADAS AS COLUNAS paciente, cpf e dentista
CREATE TABLE consultas (
  id INT AUTO_INCREMENT PRIMARY KEY,
  paciente VARCHAR(255) NOT NULL,   -- NOVO
  cpf VARCHAR(14) NOT NULL,      -- NOVO
  dentista VARCHAR(255) NOT NULL,   -- NOVO
  data DATE NOT NULL,
  hora TIME NOT NULL,
  funcionario ENUM ('Sim', 'Não') NOT NULL,

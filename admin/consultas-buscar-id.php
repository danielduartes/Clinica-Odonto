<?php
// consultas-buscar-id.php (CORRIGIDO para buscar campos de TEXTO)
...
try {
  // CORREÇÃO: Buscando os campos de texto: paciente, cpf, dentista
  $sql = "SELECT 
        id, data, hora, paciente, cpf, dentista, procedimento, funcionario 
      FROM consultas 
      WHERE id = :id";

      ...
      <div className='bg-cyan-800 min-h-screen'>
        ...
        <div className='pt-24 px-20 flex justify-between'>
          <div className='mt-16 mb-15'>
            <div>
              <p className='text-white mb-6 pb-5 border-sky-300 border-b-3 font-semibold text-3xl'>
          ...
          <div className='bg-cyan-600 p-8 pt-4 flex flex-col rounded-2xl shadow-xl mt-16 w-4/12 h-fit'>
            ...
            <div className='flex items-start gap-4 ml-1.5'>
              ...
              <div>
                <Link target='_blank' to={"https://api.whatsapp.com/send?text=https%3A%2F%2Fshare.google%2Fmt5vTDUvSNM68jJES"}><button className='mt-7 text-white bg-cyan-800 hover:bg-sky-500 p-2 px-3 rounded-lg font-semibold'>Agende sua consulta</button></Link>
              </div>
            </div>
          </div>
